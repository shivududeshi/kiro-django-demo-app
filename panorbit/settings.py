...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '3xb%+*2uex+%1&$@=*+(@^atnm!#tz-n&i5qn$o46jnp&u*2l^')
...
# Set DB_ENGINE=django.db.backends.sqlite3 in .env to use SQLite (no MySQL needed)
...
STATIC_URL = '/static/'
# Collected static files go here — served by Nginx in production
...
# Login URL — redirect unauthenticated users to login page
LOGIN_URL = 'login'

# Email configuration
# Uses console backend by default (OTP prints in terminal).
